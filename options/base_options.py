...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='face2face', help='chooses how datasets are loaded. [face2face | ubisoft | unaligned | aligned | single | colorization]')
