...
if __name__ == '__main__':
    """
    --used_device YorkU --model pix2pix --name first_try --dataroot datasets\face2face --dataset_mode ubisoft
    """
    ...
    # opt.batch_size = 1
    # print("The number of images of validation is = %d" % val_dataset_size)
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):  # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
        ...
        # print("In the validation process")
        ...
        #     t_comp = (end_val_time - start_val_time) / val_dataset_size
        #     t_data = t_comp
